...
class Neo4jDataGenerator:
    ...
    def generar_datos_escala_pequena(self, num_usuarios=10000, num_productos=500, max_pedidos_por_usuario=5):
    ...
    def _crear_pedido_completo(tx, order_id, user_id):
        ...
        for _ in range(num_productos):
            product_id = random.randint(1000, 1499)  # IDs de productos generados (500 productos)
...
if __name__ == "__main__":
    ...
    # PARÁMETROS DE ESCALA MEDIA
    NUM_USUARIOS = 10000      # <-- Ajustable
    NUM_PRODUCTOS = 500      # <-- Ajustable
