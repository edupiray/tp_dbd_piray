...
if __name__ == "__main__":
    ...
    parser.add_argument('--scale', choices=['small', 'medium', 'large', 'extra_large'], default='medium',
                       help='Escala de datos: small (100), medium (10k), large (100k), extra_large (500k)')
    ...
    elif args.scale == 'extra_large':
        num_users = 500000
        num_products = 25000
        output_file = "generacion_mongodb_500k.csv"
