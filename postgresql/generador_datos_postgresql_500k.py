...
class PostgresDataGenerator:
    ...
    def generar_datos(self, num_usuarios=500000, num_productos=25000, max_pedidos_por_usuario=5):
    ...
    def _generar_usuarios_y_pedidos(self, num_usuarios, max_pedidos_por_usuario, max_producto_id):
        """Genera usuarios y sus pedidos asociados - VERSIÓN CORREGIDA"""
...
if __name__ == "__main__":
    ...
    # =======================================================
    # CONFIGURACIÓN DE ESCALA - 100,000 USUARIOS
    # =======================================================
    ESCALA = "muy_grande"
    ...
    elif ESCALA == "muy_grande":
        NUM_USUARIOS = 500000
        NUM_PRODUCTOS = 25000
        ARCHIVO_SALIDA = "generacion_postgres_500k.csv"
